...
import id.co.japps.fasilkes.adapter.SpesialisAdapter;
...
public class SpesialisActivity extends AppCompatActivity {
    ...
    private void loadJSON(int index){
        GPSTracker gps = new GPSTracker(SpesialisActivity.this);

        Service serviceAPI = Client.getClient();
        Call<JsonArray> loadSearch = serviceAPI.getSpesialis(gps.getLatitude(),gps.getLongitude());
        loadSearch.enqueue(new Callback<JsonArray>() {
            ...
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                ...
                mAdapter = new SpesialisAdapter(mArrayList);
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        search.setOnActionExpandListener(new MenuItem.OnActionExpandListener() {
            ...
            public boolean onMenuItemActionCollapse(MenuItem menuItem) {
                View view = SpesialisActivity.this.getCurrentFocus();
                InputMethodManager imm = (InputMethodManager)getSystemService(SpesialisActivity.this.INPUT_METHOD_SERVICE);
